...
//   
  ...
  vsWell[0].vWellCoordinate.push_back(1000); // x
  vsWell[0].vWellCoordinate.push_back(250); // 45-30-90 model
  vsWell[0].vWellCoordinate.push_back(-2050.0); // z0
  vsWell[0].vWellCoordinate.push_back(-2025.0); // z1  
  vsWell[0].Type = "WCONPROD";
  vsWell[0].radius_poisk = 10.0; // m
...
void SimData::initilizeBoundaryConditions()
{
  ...
  //vsPhysicalBoundary[1].nmark = -1111112;  
  //vsPhysicalBoundary[1].vCondition.push_back(Sxx);
...
void SimData::defineRockProperties()
{
  ...
  for ( int icell = 0; icell < nCells; icell++ )
  {
    ...
    vsCellRockProps[icell].density = 2250.0;  // rock density kg/m3
    ...
    vsCellRockProps[icell].poro = 0.05;  // porosity
    ...
    vsCellRockProps[icell].biot = 1.0;
    vsCellRockProps[icell].biot_flow = 1.0;
    vsCellRockProps[icell].young = 5.0;
    vsCellRockProps[icell].poisson = 0.3;
    ...
    if ( vsCellCustom[icell].nMarker == 9999991 )
    {
      ...
      vsCellRockProps[icell].perm = 300;
      vsCellRockProps[icell].perm_x = vsCellRockProps[icell].perm;
      vsCellRockProps[icell].perm_y = vsCellRockProps[icell].perm;
      vsCellRockProps[icell].perm_z = vsCellRockProps[icell].perm / 10.0;
      
      vsCellRockProps[icell].biot = 0.8;
      vsCellRockProps[icell].biot_flow = 0.8;
      vsCellRockProps[icell].young = 1.0;
      vsCellRockProps[icell].poisson = 0.25;

      vsCellRockProps[icell].temp = 343.15;    
      vsCellRockProps[icell].pressure = 1.0 + fabs(vsCellCustom[icell].vCenter[2]) * 0.1;
      vsCellRockProps[icell].ref_pres = vsCellRockProps[icell].pressure;
      vsCellRockProps[icell].ref_temp = vsCellRockProps[icell].temp;
    }
    else
...
void SimData::definePhysicalFacets()
{
  ...
  for(int iface = 0; iface < nFaces; iface++)
  {    
    vsFaceCustom[iface].aperture = 5e-3; //m
    vsFaceCustom[iface].conductivity = 1e-12; //mD.m
  }
}
